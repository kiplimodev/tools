...
export default function WalkingCaloriesForm({
  defaultWeightKg,
  ...
  const [durationMinutes, setDurationMinutes] =
    useState(defaultDurationMinutes);
  ...
  function onSubmit(e: React.FormEvent) {
    ...
    router.push(
      `/tools/calories/walking-calorie-calculator?weightKg=${weightKg}&durationMinutes=${durationMinutes}&met=${met}`
    );
  }
