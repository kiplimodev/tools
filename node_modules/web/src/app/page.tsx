      ...
      <section className="space-y-5">
        <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          <div className="space-y-1">
            ...
            <h2 className="text-2xl font-semibold text-zinc-900 dark:text-white">Available calculators</h2>
            <p className="text-sm text-zinc-500 dark:text-zinc-400">Add them to your home screen, share the links, and stay race ready.</p>
          </div>
          <Link
        ...
        <div className="grid gap-4 md:grid-cols-2">
          {tools.map((tool) => (
            <Link
              key={tool.href}
              href={tool.href}
              className="group relative overflow-hidden rounded-2xl border border-zinc-200/80 bg-white/80 p-6 shadow-sm backdrop-blur transition hover:-translate-y-1 hover:shadow-lg dark:border-zinc-800 dark:bg-zinc-950/60"
            >
              <div className="absolute -right-10 -top-16 h-32 w-32 rounded-full bg-emerald-500/10 blur-3xl transition duration-700 group-hover:scale-110" aria-hidden />
              <div className="flex items-center justify-between">
                <span className="rounded-full bg-emerald-500/10 px-3 py-1 text-xs font-semibold text-emerald-700 ring-1 ring-emerald-200 dark:text-emerald-200 dark:ring-emerald-500/40">
                  {tool.badge}
                </span>
              ...
              <div className="mt-4 space-y-2">
                <h3 className="text-xl font-semibold text-zinc-900 dark:text-zinc-50">{tool.title}</h3>
                <p className="text-sm text-zinc-600 dark:text-zinc-400">{tool.description}</p>
              </div>
            </Link>
          ))}
