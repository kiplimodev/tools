  ...
  return (
    <main className="space-y-10">
      <div className="space-y-3">
        ...
        <h1 className="text-3xl font-semibold tracking-tight text-zinc-900 sm:text-4xl dark:text-white">TDEE Calculator</h1>
      ...
      <div className="grid gap-6 lg:grid-cols-[1.05fr_0.95fr]">
        ...
        <div className="space-y-4 rounded-2xl border border-white/40 bg-white/70 p-6 shadow-lg backdrop-blur dark:border-zinc-800 dark:bg-zinc-950/60">
          ...
          <div className="space-y-3 text-sm text-zinc-600 dark:text-zinc-400">
            ...
            <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
              <div className="rounded-xl border border-zinc-200/70 bg-white/80 p-4 shadow-inner dark:border-zinc-800 dark:bg-zinc-900/60">
                <p className="text-xs uppercase tracking-wide text-zinc-500 dark:text-zinc-400">Basal metabolic rate</p>
                <p className="text-2xl font-semibold text-zinc-900 dark:text-white">
                  {result ? `${result.bmr.toLocaleString()} kcal` : "—"}
                </p>
              </div>
              <div className="rounded-xl border border-zinc-200/70 bg-white/80 p-4 shadow-inner dark:border-zinc-800 dark:bg-zinc-900/60">
                <p className="text-xs uppercase tracking-wide text-zinc-500 dark:text-zinc-400">Total daily energy expenditure</p>
                <p className="text-2xl font-semibold text-zinc-900 dark:text-white">
          ...
          <div className="rounded-xl border border-zinc-200/70 bg-zinc-50/80 p-4 text-sm text-zinc-600 shadow-inner dark:border-zinc-800 dark:bg-zinc-950/70 dark:text-zinc-400">
            ...
            <ul className="mt-2 list-disc space-y-1 pl-5">
              ...
              <li>
                Explore more tools on the <Link href="/tools/running/running-pace-calculator" className="font-medium text-zinc-900 underline dark:text-emerald-300">Running Pace Calculator</Link> to plan cardio sessions.
              </li>
            </ul>
          </div>
        </div>
