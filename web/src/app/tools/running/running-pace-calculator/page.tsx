  ...
  return (
    <main className="space-y-10">
      <div className="space-y-3">
        ...
        <h1 className="text-3xl font-semibold tracking-tight text-zinc-900 sm:text-4xl dark:text-white">Running Pace Calculator</h1>
      ...
      <div className="grid gap-6 lg:grid-cols-[1.05fr_0.95fr]">
        <form className="space-y-5 rounded-2xl border border-white/40 bg-white/70 p-6 shadow-lg backdrop-blur dark:border-zinc-800 dark:bg-zinc-950/60" method="GET">
          ...
          <p className="text-sm text-zinc-500 dark:text-zinc-400">Use decimals for seconds (e.g., 4 minutes 30 seconds → 4.5 minutes).</p>
        </form>
          ...
          <div className="space-y-3 text-sm text-zinc-600 dark:text-zinc-400">
            ...
            <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
              ...
              <div className="rounded-xl border border-zinc-200/70 bg-white/80 p-4 shadow-inner dark:border-zinc-800 dark:bg-zinc-900/60">
                ...
                <p className="text-2xl font-semibold text-zinc-900 dark:text-white">{result ? result.pacePerMile : "—"}</p>
              </div>
              <div className="rounded-xl border border-zinc-200/70 bg-white/80 p-4 shadow-inner dark:border-zinc-800 dark:bg-zinc-900/60">
              ...
              <div className="rounded-xl border border-zinc-200/70 bg-white/80 p-4 shadow-inner dark:border-zinc-800 dark:bg-zinc-900/60">
                ...
                <p className="text-2xl font-semibold text-zinc-900 dark:text-white">{result ? `${result.speedMph} mph` : "—"}</p>
              </div>
            </div>
            {!result && <p className="text-sm text-zinc-500 dark:text-zinc-400">Enter a distance and time to generate pace and speed metrics.</p>}
            <p className="text-xs text-zinc-500 dark:text-zinc-400">Pace formatting uses mm:ss for quick readability.</p>
          </div>
        </div>
      </div>
    </main>
